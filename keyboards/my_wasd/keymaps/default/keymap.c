...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = KEYMAP( /* Base */
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                    KC_SPACE,                  KC_RALT, KC_RGUI, MO(1), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  [1] = KEYMAP( /* Function Layer */
    KC_NO,        KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO,    KC_NO,   KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_MUTE, \
    KC_NO, KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO, KC_NO,         KC_NO, KC_MPLY, KC_MSTP, KC_VOLU, \
